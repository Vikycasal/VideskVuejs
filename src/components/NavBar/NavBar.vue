    ...
    <div class="container px-4 mx-auto flex flex-wrap items-center justify-between">
      ...
      <div v-bind:class="{'hidden': !showMenu, 'flex': showMenu}" class="lg:flex lg:flex-grow items-center">
        <ul class="flex flex-col lg:flex-row list-none ml-auto">
          <li class="nav-item">
            <a class="px-2 py-3 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75" href="#menu">
              <i class="fab fa-facebook-square text-lg leading-lg text-white opacity-75" /><span class="ml-2">Menu</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="px-2 py-3  flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75" href="#menu">
              <i class="fab fa-twitter text-lg leading-lg text-white opacity-75" /><span class="ml-2">Menu</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="px-2 py-3  flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75" href="#menu">
              <i class="fab fa-pinterest text-lg leading-lg text-white opacity-75" /><span class="ml-2">Menu</span>
            </a>
          </li>
                    <li class="nav-item">
            <a class="px-2 py-3  flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75" href="#menu">
